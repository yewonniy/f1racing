...
public class RaceDataRedisDto {
    ...
    // 1. 2025년 엔티티 -> Redis DTO 변환
    public static RaceDataRedisDto from(RaceData25 entity) {
        return RaceDataRedisDto.builder()
    ...
    // 2. 2024년 엔티티 -> Redis DTO 변환
    public static RaceDataRedisDto from(RaceData24 entity) {
        return RaceDataRedisDto.builder()
                .driverNumber(entity.getDriverNumber())
                .x(entity.getX())
                .y(entity.getY())
